 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       1251        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define Z_STALL_SENSITIVITY  221
   ...
   */
   #define TMC_HOME_PHASE { 640, 640, 384 }
